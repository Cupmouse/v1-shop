export const API_URL = process.env.NODE_ENV === 'production' ? 'https://shopapi.exchangedataset.cc' : 'http://localhost:3001';
export const HOME_URL = 'https://www.exchangedataset.cc';
